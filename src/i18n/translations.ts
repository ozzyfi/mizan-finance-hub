...
export const translations = {
  ...
  aiChatTitle: { tr: "AI Finansman Danışmanı", en: "AI Finance Advisor" },
  aiChatSubtitle: { tr: "Tüm seçenekleri biliyor", en: "Knows all options" },
  aiChatOnline: { tr: "Aktif", en: "Online" },
  aiChatPlaceholder: { tr: "Bir soru sorun...", en: "Ask a question..." },
  aiQuickQ1: { tr: "İkisi arasındaki fark nedir?", en: "What's the key difference?" },
  aiQuickQ2: { tr: "Belge gereksinimleri?", en: "Document requirements?" },
  aiQuickQ3: { tr: "Risk nasıl düşer?", en: "How to reduce risk?" },
  aiQuickQ4: { tr: "Bankaya ne sormalıyım?", en: "What to ask the bank?" },
  aiChatError: { tr: "Bağlantı hatası, tekrar deneyin.", en: "Connection error, please retry." },
